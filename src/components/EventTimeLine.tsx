...
const EventTimeLine:React.FC<EventTimeLineType> = ({ event }) => {
  return (
    <div className="pb-5 w-full border-l-2 border-gray-500 pl-8 relative before:absolute before:w-4 before:h-4 before:rounded-full before:-left-[9px] before:top-[10px] before:bg-gray-500">
      <motion.p 
        //drag
      ...
      before:w-5 before:h-5 before:bg-white before:-left-2 before:rotate-45 before:z-0">
